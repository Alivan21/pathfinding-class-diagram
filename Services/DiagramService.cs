    ...
    public class DiagramService : IDiagramService
    {
            ...
            bool showRelationships)
        {
            ...
            using (Graphics g = Graphics.FromImage(bitmap))
            {
                ...
                {
                    DrawRelationships(g, classDiagrams, relationships, bitmapWidth, bitmapHeight);
                }
            }
        ...
        /// <summary>
        /// Finds the closest points between two class diagrams and snaps them to the nearest edges
        /// </summary>
        ...
        /// <summary>
        /// Snaps a point to the nearest edge of a class diagram
        /// </summary>
        ...
        /// <summary>
        /// Draws a connector path between two class diagrams with appropriate styling
        /// </summary>
